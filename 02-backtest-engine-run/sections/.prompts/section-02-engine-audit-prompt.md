...
Generate content for section `section-02-engine-audit` (filename: `section-02-engine-audit.md`).
...
for `section-02-engine-audit` to understand what this section should contain.
...
`/Volumes/One Touch/NSE/onesec/curvex/02-backtest-engine-run/sections/section-02-engine-audit.md`
