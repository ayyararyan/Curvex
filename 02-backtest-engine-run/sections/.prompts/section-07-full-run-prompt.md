...
Generate content for section `section-07-full-run` (filename: `section-07-full-run.md`).
...
for `section-07-full-run` to understand what this section should contain.
...
`/Volumes/One Touch/NSE/onesec/curvex/02-backtest-engine-run/sections/section-07-full-run.md`
