...
Generate content for section `section-05-performance-index` (filename: `section-05-performance-index.md`).
...
for `section-05-performance-index` to understand what this section should contain.
...
`/Volumes/One Touch/NSE/onesec/curvex/02-backtest-engine-run/sections/section-05-performance-index.md`
