...
Generate content for section `section-04-test-suite` (filename: `section-04-test-suite.md`).
...
for `section-04-test-suite` to understand what this section should contain.
...
`/Volumes/One Touch/NSE/onesec/curvex/01-signal-audit-fix/sections/section-04-test-suite.md`
