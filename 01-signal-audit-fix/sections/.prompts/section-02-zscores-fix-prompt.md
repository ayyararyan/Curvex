...
Generate content for section `section-02-zscores-fix` (filename: `section-02-zscores-fix.md`).
...
for `section-02-zscores-fix` to understand what this section should contain.
...
`/Volumes/One Touch/NSE/onesec/curvex/01-signal-audit-fix/sections/section-02-zscores-fix.md`
