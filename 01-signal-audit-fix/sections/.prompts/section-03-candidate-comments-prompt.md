...
Generate content for section `section-03-candidate-comments` (filename: `section-03-candidate-comments.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/Volumes/One Touch/NSE/onesec/curvex/01-signal-audit-fix/claude-plan.md` - Full implementation plan
2. `/Volumes/One Touch/NSE/onesec/curvex/01-signal-audit-fix/claude-plan-tdd.md` - Test stubs for each section
3. `/Volumes/One Touch/NSE/onesec/curvex/01-signal-audit-fix/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-03-candidate-comments` to understand what this section should contain.
...
`/Volumes/One Touch/NSE/onesec/curvex/01-signal-audit-fix/sections/section-03-candidate-comments.md`
