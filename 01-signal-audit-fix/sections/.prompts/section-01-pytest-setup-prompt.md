...
Generate content for section `section-01-pytest-setup` (filename: `section-01-pytest-setup.md`).
...
for `section-01-pytest-setup` to understand what this section should contain.
...
`/Volumes/One Touch/NSE/onesec/curvex/01-signal-audit-fix/sections/section-01-pytest-setup.md`
